...
\toprule
\endhead
$metadata.table1.theme$ & &\tabularnewline
$metadata.table1.date$ & &\tabularnewline
$metadata.table1.group$ & $metadata.table1.your_number$ & $metadata.table1.your_name$ \tabularnewline
\bottomrule
\end{longtable}
...
\toprule
\endhead
$metadata.table2.collaborator$ \tabularnewline
\bottomrule
\end{longtable}
...
\toprule
\endhead
$metadata.table3.reporting_date$ & $metadata.table3.re_reporting_date_r1$ & $metadata.table3.re_reporting_date_r3$ \tabularnewline
\bottomrule
\end{longtable}
